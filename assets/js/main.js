...
// 01_php_services.html Start ...

// let text = document.getElementById('hero-sec-heading');

// window.addEventListener('scroll', () => {
//   let value = window.scrollY;
//   // console.log(value)
//   text.style.marginTop = value * 1.4 + 'px';
//   // if(text.style.marginTop > (500 + 'px')){
//   //   text.style.marginTop = 500 + 'px';
//   // }
// });

// let footerStopScroll = document.querySelector('.01phpservice')

// if(footerStopScroll == true){
